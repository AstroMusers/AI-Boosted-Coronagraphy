...
class RefactoredCoron3Pipeline(Pipeline):
    ...
    def process(self, user_input):
        ...
        try:
            ...
            table_name = input_models.meta.asn_table.products[0].members[0]['expname'][:64]
            result.meta.asn.table_name = op.basename(table_name)
        except AttributeError:
