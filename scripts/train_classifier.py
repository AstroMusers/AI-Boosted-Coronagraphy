...
def train_arg_parser():
    ...
    parser.add_argument('--idx',type=str, default='classifier_filter/0')
...
injected = glob.glob(os.path.join(INJECTIONS2, args.train_folder, '*fc5.npy'))[:10000]
not_injected = glob.glob(os.path.join(INJECTIONS2, args.train_folder, '*[!fc5].npy'))[:10000]
