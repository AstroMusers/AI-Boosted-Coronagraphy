...
injected = glob.glob(os.path.join(INJECTIONS, args.train_folder, '*fc5.npy'))[:50000]
not_injected = glob.glob(os.path.join(INJECTIONS, args.train_folder, '*[!fc5].npy'))[:50000]
